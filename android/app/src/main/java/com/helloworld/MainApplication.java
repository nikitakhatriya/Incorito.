  ...
  private final ReactNativeHost mReactNativeHost =
      new ReactNativeHost(this) {
        ...
        protected List<ReactPackage> getPackages() {
          ...
          packages.add(new RNFirebaseAuthPackage()); // Firebase Authentication
          packages.add(new RNFirebaseFirestorePackage()); // Firestore database
          packages.add(new RNFirebaseMessagingPackage()); // Firebase Notification
          packages.add(new RNFirebaseNotificationsPackage()); // Firebase Notification
          return packages;
        }
